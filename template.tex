...
\begin{spreadtab}{{tabular}[t t t]{lp{10.5cm}r r}}
  @ \noalign{\vskip 2mm} \textbf{Pos.} & @ \textbf{Description} & @ \textbf{Hours} & @ \textbf{$currency$} \\ \hline
  ...
  $endif$
  @ & @ \multicolumn{2}{r}{\textbf{Total:}}   & \textbf{:={$if(VAT)$[0,-1]+[0,-2]$else$sum(c1:[0,-1])$endif$}} \\
\end{spreadtab}
